...
public class GetOpponentCmd {

    private final String userId;

    public GetOpponentCmd(String userId) {
        this.userId = userId;
    }
    ...
    public ApiResponse<String> execute() {
        ...
        if (matchPlayersResponse.isSucceeded()) {
            String opponentId = matchPlayersResponse.getValue();
            retVal = ApiResponse.createSucceededResponse(opponentId);
        }
        else {
