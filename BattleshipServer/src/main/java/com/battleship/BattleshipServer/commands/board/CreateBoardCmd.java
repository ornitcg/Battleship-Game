...
/*
*  CreateBoardCmd class is responsible for creating the board.
*  The class is responsible for creating the board, the tiles, and the ships.
* */
public class CreateBoardCmd {
    ...
    /*
     *  This method calculates the ship id by position.
     *  The method returns a map that contains the ship id by position.
     *  The position is the key, and the ship id is the value.
     * */
    ...
    /*
     *  This method is responsible for the synchronization of the game start.
     *  The first user to create the board will insert gameId to the set, the second user will extract it.
     *  When the second user finishes to build the board, he will notify the first user.
     * */
    ...
    /*
    *  This method checks if the second user finished to build the board.
